...
def usp_up():
    ...
    # 指定操作
    action1.press(x=30, y=1883).wait(1000).move_to(x=30, y=1000).wait(1000).release()
    action2.press(x=80, y=1883).wait(1000).move_to(x=80, y=1000).wait(1000).release()
...
if __name__ == "__main__":
    ...
    remote_path_0 = "/idcm-release/dailybuild/gin-dev/" + "2020-07-17-01-13-01/gin-userdebug-img.tar.gz"
    ...
    try:
        downloadfile(ftp, remote_path_2 + '/gin-userdebug-img.tar.gz', local_path)
    except ftplib.error_perm:
        downloadfile(ftp, remote_path_2 + '/gin-userdebug-fullbuild-img.tar.gz', local_path)
    ftp.quit()
    ...
    sleep(10)
    shutil.copy('/home/shileiwu/build/UsbBuild/la_system.img', '/media/shileiwu/E862-18A1/UpdatePackage/ARM/la_system.img')
    shutil.copy('/home/shileiwu/build/UsbBuild/la_vendor.img', '/media/shileiwu/E862-18A1/UpdatePackage/ARM/la_vendor.img')
    shutil.copy('/home/shileiwu/build/UsbBuild/persist.img', '/media/shileiwu/E862-18A1/UpdatePackage/ARM/persist.img')
    shutil.copy('/home/shileiwu/build/UsbBuild/userdata.img', '/media/shileiwu/E862-18A1/UpdatePackage/ARM/userdata.img')
    sleep(1800)
    usp_up()
